...
export default function DeleteTeamMember({ member, setShowDeleteModal }) {
  const businessId = "672df89b557f80708102b786";
  const teamMemberId = member._id;
  ...
  const handleDeleteButton = async () => {
    ...
    try {
      const response = await fetch(
        `${API_URL}data/business/${businessId}/team-member/${teamMemberId}`,
        {
          method: "DELETE",
          headers: {
              ...
              <div className="w-full flex flex-col gap-5">
                ...
                <div className="text-center">
                  <h1 className="text-lg font-semibold">
                    Are you sure you want to delete the information of "
