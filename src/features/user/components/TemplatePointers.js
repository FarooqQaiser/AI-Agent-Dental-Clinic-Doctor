function TemplatePointers() {
  return (
    <>
      <h1 className="text-2xl mt-8 font-bold">Core Features</h1>{" "}
      ...
      {/* <p className="py-2 mt-4">
        ✓ <span className="font-semibold">Settings Management</span>
      </p> */}
      <p className="py-2 mt-4">
        ✓ <span className="font-semibold">Bots Management</span>
      </p>
      <p className="py-2 mt-4">
        ✓ <span className="font-semibold">Bot Communication</span>
      </p>
