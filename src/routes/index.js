...
const BusinessManagement = lazy(() =>
  import("../pages/protected/BusinessManagement")
);
const Settings = lazy(() => import("../pages/protected/Settings"));
const Appointments = lazy(() => import("../pages/protected/Appointments"));
const BotsManagement = lazy(() => import("../pages/protected/BotsManagement"));
const BotCommunication = lazy(() =>
  import("../pages/protected/BotCommunication")
);
...
const routes = [
  ...
  {
    path: "/bot-communication",
    component: BotCommunication,
  },
  {
    path: "/whatsapp",
    component: Whatsapp,
